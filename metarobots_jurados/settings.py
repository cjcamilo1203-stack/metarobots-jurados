"""
Django settings for metarobots_jurados project.
...
SECRET_KEY = 'django-insecure-!2u7t)vzva#+gdjd^aq4a^nw9e$p_^p+6=$x1gcox)wh84^t7%'
...
ROOT_URLCONF = 'metarobots_jurados.urls'
...
WSGI_APPLICATION = 'metarobots_jurados.wsgi.application'
